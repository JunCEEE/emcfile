...
def read_array(
    ...
    *,
    ...
    return cast(List[Any], ans.reshape(reshape))
...
def _check_exists(
    group_name , fp  , overwrite , verbose 
)  :
...
def _write_group(
    fp , group_name , obj  , overwrite , verbose 
)  :
